...
<head>
  ...
  <title>Sana Krishna | Portfolio</title>
  <style>
    body {
      font-family: blue, sans-serif;
      margin: 0;
      padding: 0;
      background:black#080879;
      color: #333;
    }
    header {
      background:blue;
    ...
    .about, .skills, .projects, .experience, .education, .services, .achievements, .contact {
       width: 100%;              
      margin: 0;                
      background: #b09393;
      padding: 60px 40px;        
...
<body>
  <header>
    ...
    <img src="k1.jpg" alt="Sana Krishna Photo">
    <h1>Sana Krishna</h1>
